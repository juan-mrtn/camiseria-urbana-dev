...
import { Ticket, ChevronLeft, Calendar, Tag, Percent } from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-200 mb-8">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <p className="text-gray-500 font-medium">
            Crea cupones de descuento y promociones globales para tus clientes (PBI-27).
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Nuevo Cupón</h2>
              <CouponForm />
            </div>
          </div>
            ...
            <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden">
              {promociones.length === 0 ? (
                <div className="p-8 text-center text-gray-500">
                  Aún no hay cupones creados. Crea el primero usando el formulario.
                </div>
              ) : (
